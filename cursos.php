		...
		<div class="container-fluid">
			...
			<div class="container">
				<ul class="playlist-filter controls">
					<li class="control" data-filter=".genres">Profissionalizantes</li>
					<li class="control" data-filter=".artists">Moda e Maquiagem</li>
					<li class="control" data-filter=".movies">Música</li>
					<li class="control" data-filter=".labels">Programação</li>
					<li class="control" data-filter=".renda">Renda extra</li>
